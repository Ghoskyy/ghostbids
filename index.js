...
`;
        ...
        break;
      case "owner":
        sendKontak(from, owner, "Wisnuuu", "Sibuk nge jomblooo");
        break;
...
case "textburn":
				...
				if (args.length < 1) return fakestatus(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}textburn ghosky`)
				fakestatus('Bentar lagi di proses')
...
case "quote":
				...
				if (args.length < 1) return fakestatus(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}quote ghosky`)
				fakestatus('Bentar lagi di proses')
kontol = body.slice(7)
...
case "wooden":
				...
				if (args.length < 1) return fakestatus(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}wooden ghosky`)
				fakestatus('Bentar lagi di proses')
kontol = body.slice(8)
...
case "roses":
				...
				if (args.length < 1) return fakestatus(`Textnya Mana Cuy?\n*Contoh ${prefix}googlemaker ${prefix}roses ghosky`)
				fakestatus('Bentar lagi di proses')
kontol = body.slice(7)
...
*Model* : ${i.phone.device_model}\n\n`;
      ...
      case "grup":
        ...
        case "wisnu":
        if (!mek.key.fromMe) return;
        sendButMessage(from, `Mau tanya² tentang wisnu?`, `FOLLOW INSTAGRAM GW BG @iamghosky_ terima kasih`, [
          {
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        media = await syaa.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `by Ghosky bid\nnomor owner : +6289653381067\nnomor bot: +994 40 549 40 17\nfollow ig owner syg : @iamghosky_`;
